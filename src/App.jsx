...
import { formatearDinero, calularTotalPagar} from './helpers'
...
function App() {
  ...
  useEffect(() => {
    const resultadoTotalPagar = calularTotalPagar(cantidad, meses);
  ...
  function handleChange(e){
    //console.log(+e.target.value); // + lo hace numero
